...
COMPILER_RT = -L$(NAVY_HOME)/libs/compiler-rt/build -l:compiler-rt-riscv32i.a
$K/kernel: $(OBJS) $K/kernel.ld $U/initcode
	$(LD) $(LDFLAGS) -T $K/kernel.ld -o $K/kernel $(OBJS) $(COMPILER_RT)
...
$U/_forktest: $U/forktest.o $(ULIB)
	...
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -o $U/_forktest $U/forktest.o $U/ulib.o $U/usys.o $(COMPILER_RT)
...
QEMUOPTS = -machine virt -bios none -kernel $K/kernel -m 1024M  -nographic
